...
func (m *mockOrderService) CreateOrder(_ context.Context, _ order.CreateOrderCmd) (string, error) {
	return m.createOrderResult, m.createOrderErr
}
func (m *mockOrderService) List(_ context.Context, _ order.ListRequest) (*order.ListResponse, error) {
	return m.listResult, m.listErr
}

// ---------------------------------------------------------------------------
// seederUserAdapter — missing error paths
// ---------------------------------------------------------------------------
...
func TestSeederOrderAdapter_CreateOrder_Success(t *testing.T) {
	t.Parallel()
	mock := &mockOrderService{createOrderResult: "order-123"}
...
func TestSeederOrderAdapter_CreateOrder_Error(t *testing.T) {
	t.Parallel()
	mock := &mockOrderService{createOrderErr: errors.New("order error")}
	a := &seederOrderAdapter{svc: mock}
...
func TestSeederOrderAdapter_List_Success(t *testing.T) {
	...
	// ID and UserID are strconv.FormatInt-converted
...
func TestSeederOrderAdapter_List_Error(t *testing.T) {
	t.Parallel()
	mock := &mockOrderService{listErr: errors.New("list error")}
	a := &seederOrderAdapter{svc: mock}

...
// serve contains all logic previously in main, making it fully testable.
// It returns an exit code (0 = success, non-zero = failure).
func serve(args []string, deps Dependencies) int {
	...
	deps.Printf("    servener.Register(%[1]sProjector)\n", spec.Name)                                      //nolint:forbidigo
	...
	deps.Println("Then serve:")                                                                            //nolint:forbidigo
